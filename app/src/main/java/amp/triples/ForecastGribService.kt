...
class ForecastGribService(private val service: Service) : ServiceCommand {

    var serviceParam: ForecastGribParam? = null
    ...
    override fun url(): String {
        ...
        val requestUrl = StringBuilder().apply {
            ...
            append("&base_date=${serviceParam?.base_date ?: DateTime.baseTime2().substring(0, 8)}")
            append("&base_time=${serviceParam?.base_time ?: DateTime.baseTime2().substring(8)}")
